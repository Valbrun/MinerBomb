...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        parentContainer = findViewById(R.id.root);
        aPlayer = new Player("Woodsen");
    ...
    private List<LinearLayoutCompat> makePlayground(Context context, int rows, int colomns) {
        ...
        LayoutParams layoutParamsRow = makeLayoutParams(0, 3,
                3, 0, 0);
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == STARTBUTTONID) {
            ...
            if(miners.isEmpty() && aPlayer.getScore() < 6000){
                Toast.makeText(this,"Game Over",Toast.LENGTH_LONG ).show();
            }else if(aPlayer.getScore() >= 6000){
